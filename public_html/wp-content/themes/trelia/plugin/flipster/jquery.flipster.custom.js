...
( function($) {
  'use strict';
  $(function(e) {
    if($(".my-flipster").length>0) {
          $(".my-flipster").each(function(index, el) {
            var blockContent = $(this).next();
            var number_1= $(".number-1",$(this).prev());
            var number_2= $(".number-2",$(this).prev());
            $(number_2).html($(this).data("total"));
            $(this).flipster({
              style: 'infinite-flat',
              spacing: -0.6,
              scrollwheel: false,
              ...
              onItemSwitch:function(currentItem, previousItem){
                ...
                $(blockContent).html($(".info",currentItem).html());  
                $(number_1).html($(currentItem).data('index'));

              }
              //buttons: true,
            });
            $(blockContent).html($(".flipster__item--current .info", this).html());
            $(number_1).html($(".flipster__item--current", this).data('index'));
          });
        }
 });
})(jQuery);
